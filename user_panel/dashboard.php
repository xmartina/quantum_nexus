    ...
    <div class="container py-2">
        <div class="alert custom-alert-2 alert-primary alert-dismissible fade show" role="alert">
            <i class="bi bi-info-circle"></i>Welcome, fad <a href="" class="text-white">
                <strong><pre style="position: relative;">  Last Access: Just Now&nbsp; <div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre></strong></a>
            ...
            <ul style="color:red">
                <div class="d-flex justify-content-between">
                    <div class="timeline-text mb-2">
                        ...
                        <form method="post"><input type="hidden" name="form_id" value="17080893705524"><input type="hidden" name="form_token" value="a3dc612fd14d1293938af6cce407fbc8">
...
<div class="container mb-3 pb-4">
    <div class="card bg-primary mb-3 bg-img" style=" background-image:https://brainboxoptionsinv.com/themes/berry-classic/img/core-img/1.png" ;="">
        <div class="card-body direction-rtl p-4 ">
            <div class="sidenav-style1"></div>
            <h6 class="text-white">Referral Link</h6>
            <p class="mb-4 text-white">
                https://brainboxoptionsinv.com/?ref=fad</p><button onclick="copyRef()" class="clip btn btn-secondary shadowed">
            ...
            <a href="whatsapp://send?text=https://brainboxoptionsinv.com/?ref=fad"><i class="bi bi-whatsapp text-white" style="font-size: 20px"> </i>
            </a>&nbsp;

            <a href="https://t.me/share/url?url=https://brainboxoptionsinv.com/?ref=fad"><i class="bi bi-telegram text-white" style="font-size: 20px"> </i>
            </a>&nbsp;

            <a href="https://twitter.com/intent/tweet?url=https://brainboxoptionsinv.com/?ref=fad"><i class="bi bi-twitter text-white" style="font-size: 20px"></i>
            </a>&nbsp;

            <a href="https://www.facebook.com/sharer/sharer.php?u=https://brainboxoptionsinv.com/?ref=fad"><i class="bi bi-facebook text-white" style="font-size: 20px"></i></a>
        </div>
    </div>
</div>
<div class="pb-3">
